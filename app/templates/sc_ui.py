...
"")
        ...
        self.bg_loading = QtWidgets.QLabel(self.loading)
        self.bg_loading.setGeometry(QtCore.QRect(0, 0, 900, 600))
        self.bg_loading.setStyleSheet("")
        self.bg_loading.setText("")
        self.bg_loading.setObjectName("bg_loading")
